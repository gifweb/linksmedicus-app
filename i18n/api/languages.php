...
$translate = new TranslateClient(['key' => $config['key']]);

$request_body = file_get_contents('php://input');
$data = json_decode($request_body);

$target = ($data && $data->lang) ? $data->lang : 'en';
$data = $translate->localizedLanguages([    'target' => $target,]);
